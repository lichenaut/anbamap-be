...
fn remove_ambiguities(
    ...
    let vec: Vec<(Vec<String>, String)> = vec
        .into_par_iter()
        .map(|(keys, value)| {
...
pub static KEYPHRASE_REGION_MAP: Lazy<Vec<(Vec<String>, String)>> = Lazy::new(|| {
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                "international holding co".into(),
                "taqa".into(),
                "adnoc".into(),
                "emirates telecom".into(),
                "alpha dhabi".into(),
                "invest bank".into(),
                "dewa".into(),
                "emirates nbd".into(),
                "emirates pjsc".into(),
                "borouge".into(),
                "emaar properties".into(),
                "q holding".into(),
                "al dar properties".into(),
                "pure health holding".into(),
                "mashreqbank".into(),
            ]),
            misc: None,
        }
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                "mercadolibre".into(),
                "ypf".into(),
                "yacimientos petroliferos".into(),
            ]),
            misc: Some(vec![
                "casa rosada".into(),
                "union for the homeland".into(),
                "juntos por el cambio".into(),
                "cambiemos".into(),
                "peronis".into(),
                "kirchneris".into(),
            ]),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "cochlear".into(),
                "suncorp".into(),
                "brambles limited".into(),
                "reece group".into(),
                "origin energy".into(),
                "northern star inc".into(),
                "scentre group".into(),
                "south32".into(),
                "computershare".into(),
                "mineral resources inc".into(),
                "seven group".into(),
                "sgh".into(),
            ]),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: None,
            misc: Some(vec![
                "alliance of independent social democrats".into(),
                "party of democratic action".into(),
            ]),
        }
        .get_region_vec(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            misc: Some(vec![
                "shura council".into(),
                "asalah".into(),
                "progressive democratic tribune".into(),
                "bchr".into(),
            ]),
        }
        .get_region_vec(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            misc: Some(vec![
                "cndd".into(),
                "national congress for liberty".into(),
                "national congress for freedom".into(),
            ]),
        }
        .get_region_vec(),
        "Burundi".into(),
    ...
    map.push((
        ...
        .get_region_vec(),
        "Bonaire, Sint Eustatius, and Saba".into(),
    ));
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "klabin".into(),
                "itausa".into(),
                "rede d'or sao luiz".into(),
                "bb seguridade".into(),
                "seguridade participacoes".into(),
                "suzano".into(),
                "jbs".into(),
                "b3".into(),
                "xp inc".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "tc energy".into(),
                "cenovus".into(),
                "imperial oil inc".into(),
                "loblaw".into(),
                "agnico eagle".into(),
                "restaurant brands international".into(),
                "barrick gold".into(),
                "bce inc".into(),
                "sun life financial".into(),
                "intact financial inc".into(),
                "great-west lifeco".into(),
                "nutrien inc".into(),
                "teck resources".into(),
                "fairfax".into(),
                "wheaton precious".into(),
                "wheaton metals".into(),
                "dollarama".into(),
                "franco-nevada".into(),
                "telus".into(),
                ...
                "tourmaline oil".into(),
                "ritchie bros".into(),
                "magna international".into(),
                "power financial inc".into(),
                "metro inc".into(),
                "gfl".into(),
                "first quantum minerals".into(),
                "arc resources".into(),
                "tfi international".into(),
                "emera".into(),
                "lundin mining".into(),
            ]),
            misc: Some(vec![
                "parliament hill".into(),
                "rcmp".into(),
                "ndp".into(),
                "quebecois".into(),
                "metis".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            misc: Some(vec![
                "udps".into(),
                "common front for congo".into(),
                "kabila coalition".into(),
                "lamuka".into(),
                "fardc".into(),
                "monusco".into(),
            ]),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "richemont".into(),
                "glencore".into(),
                "zurich insurance".into(),
                "sika".into(),
                "holcim".into(),
                "te connectivity".into(),
                "alcon".into(),
                "givaudan".into(),
                "lonza".into(),
                "stmicroelectronics".into(),
                "partners group".into(),
                "swiss re".into(),
                "garmin".into(),
                "kuhne + nagel".into(),
                "dsm-firmenich".into(),
                "schindler group".into(),
                "lindt".into(),
                "straumann".into(),
                "geberit".into(),
                "ems-chemie".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "meituan".into(),
                "byd".into(),
                "foxconn industrial".into(),
                "foxconn internet".into(),
                "netease".into(),
                "zijin mining".into(),
                "nongfu spring".into(),
                "midea inc".into(),
                ...
                "jingdong mall".into(),
                "mindray".into(),
                "industrial bank inc".into(),
                "citic".into(),
                "hikvision".into(),
                "jiangsu hengrui".into(),
                "haier smart home".into(),
                "haier home".into(),
                "wanhua chem".into(),
                "baidu".into(),
                "luzhou laojiao".into(),
                ...
                "pudong".into(),
                "gree electric".into(),
                "gree appliances".into(),
                "anta sports".into(),
                "kuaishou tech".into(),
                "luxshare".into(),
                "the people's insurance co".into(),
                "picc".into(),
                "cosco shipping".into(),
                "east money information".into(),
                "great wall motors".into(),
                "crrc".into(),
                "s.f. express".into(),
                "sf express".into(),
                "li auto".into(),
                ...
                "boe tech".into(),
                "minsheng bank".into(),
                "yankuang energy".into(),
                "yanzhou coal".into(),
                "yanzhou mining".into(),
                "bank of jiangsu".into(),
                "sungrow power".into(),
                "yanghe".into(),
                "zto".into(),
                "weichai".into(),
                "sany heavy industry".into(),
                "sany industry".into(),
                "beigene".into(),
                "longi ".into(),
                "seres group".into(),
                ...
                "zte".into(),
                "shandong gold".into(),
                "shandong mining".into(),
                "huaneng".into(),
                "aier eye".into(),
                "aier hospital".into(),
                "huatai securities".into(),
                "guotai junan".into(),
                "longyuan power".into(),
                "hua xia".into(),
                "hai di lao".into(),
                "shekou industrial".into(),
                "hansoh pharma".into(),
                "tsingtao".into(),
                "new oriental inc".into(),
                "longfor group".into(),
                "geely".into(),
                "huazhu hotels".into(),
                "jd health".into(),
            ...
            misc: Some(vec![
                "national people's congress".into(),
                "cppcc".into(),
                "kuomintang".into(),
                "guomindang".into(),
                "yangtze".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: None,
            misc: Some(vec![
                "inter-american court of human rights".into(),
                "social democratic progress party".into(),
                "national liberation party".into(),
                "verdiblancos".into(),
            ]),
        }
        .get_region_vec(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "repsol".into(),
                "edp renovaveis".into(),
                "international consolidated airlines".into(),
                "sabadell".into(),
                "grupo acs".into(),
            ]),
            misc: Some(vec![
                "cortes generales".into(),
                "psoe".into(),
                "sumar".into(),
            ]),
        }
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: None,
            misc: Some(vec![
                "house of federation".into(),
                "house of people's representatives".into(),
                "prosperity party".into(),
                "national movement of amhara".into(),
            ]),
        }
        .get_region_vec(),
        "Ethiopia".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "totalenergies".into(),
                "dior".into(),
                "schneider electric".into(),
                "sanofi".into(),
                "air liquide".into(),
                "essilorluxottica".into(),
                "safran".into(),
                "bnp paribas".into(),
                "axa".into(),
                "vinci".into(),
                "dassault".into(),
                "credit agricole".into(),
                "compagnie de saint-gobain".into(),
                "kering".into(),
                "danone".into(),
                "engie".into(),
                "pernod ricard".into(),
                ...
                "carrefour".into(),
                "biomerieux".into(),
                "unibail-rodamco".into(),
                "rodamco-westfield".into(),
                "vivendi".into(),
                "accor inc".into(),
                "ipsen".into(),
                "eiffage".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "arm holding".into(),
                "bp".into(),
                "glaxosmithkline".into(),
                "relx".into(),
                "diageo".into(),
                "aon".into(),
                "national grid inc".into(),
                "bae systems".into(),
                "compass group".into(),
                "anglo american inc".into(),
                "rolls-royce".into(),
                "lloyds bank".into(),
                "ferguson inc".into(),
                "barclays".into(),
                "reckitt benckiser".into(),
                "haleon".into(),
                "natwest".into(),
                "3i group".into(),
                "ashtead".into(),
                ...
                "sse".into(),
                "standard chartered".into(),
                "imperial brands inc".into(),
                "legal & general".into(),
                "bt group".into(),
                "intercontinental hotels group".into(),
                "royalty pharma".into(),
                "segro".into(),
                "next plc".into(),
                "informa plc".into(),
    ...
    map.push((
        ...
        .get_region_vec(),
        "South Georgia and the South Sandwich Islands".into(),
    ));
    map.push((
        RegionKeyphrases {
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                "aia".into(),
                "sun hung kai".into(),
                "jardine matheson".into(),
                "hang seng".into(),
                "techtronic".into(),
                "mtr".into(),
                "galaxy entertainment".into(),
                "clp".into(),
                "ck hutchison".into(),
                "budweiser apac".into(),
                "lenovo".into(),
                "ck asset".into(),
                "ck holding".into(),
                "ck infrastructure".into(),
                "chow tai fook".into(),
                "power assets inc".into(),
                "link reit".into(),
                "swire".into(),
                "orient overseas".into(),
                "futu holding".into(),
                "wharf reic".into(),
                "wharf holding".into(),
                "sino land".into(),
    ...
    map.push((
        ...
        .get_region_vec(),
        "Heard Island and McDonald Islands".into(),
    ));
    map.push((
        RegionKeyphrases {
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "chandra asri".into(),
                "raykat".into(),
                "bayan resources".into(),
                "mandiri".into(),
                "astra international".into(),
            ]),
            misc: Some(vec![
                "pdi-p".into(),
                "golkar".into(),
                "prosperous justice party".into(),
            ]),
        }
        .get_region_vec(),
        "Indonesia".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "medtronic".into(),
                "trane tech".into(),
                "cement roadstone".into(),
                "johnson controls".into(),
                "experian".into(),
                "ingersoll".into(),
                "flutter entertainment".into(),
                "ryanair".into(),
                "icon plc".into(),
                "steris".into(),
                "aptiv inc".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "ntpc".into(),
                "axis bank".into(),
                "oil & natural gas inc".into(),
                "adani".into(),
                "mahindra".into(),
                "dmart".into(),
                "titan company inc".into(),
                "ultratech cement".into(),
                "asian paints inc".into(),
                "wipro".into(),
                "jio financial".into(),
                "jio services".into(),
                "jsw".into(),
                "dlf".into(),
                "varun".into(),
                "bharat electronics".into(),
                "zomato".into(),
                "interglobe aviation".into(),
                "trent limited".into(),
                "vedanta".into(),
                "grasim".into(),
                "power finance corp".into(),
                "ambuja".into(),
                "pidilite".into(),
                "hindalco".into(),
                "sbi life".into(),
                "rural electrificaiton group".into(),
                "ltimindtree".into(),
                "punjab bank".into(),
                "punjab national".into(),
                "bank of baroda".into(),
                "gail inc".into(),
                "godrej".into(),
                "eicher motor".into(),
                "britannia industries".into(),
                "lodha".into(),
                "havells".into(),
                "cipla".into(),
                "indusind".into(),
    ...
    map.push((
        ...
        .get_region_vec(),
        "British Indian Ocean Territory".into(),
    ));
    map.push((
        RegionKeyphrases {
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "nomura".into(),
                "tdk".into(),
                "astellas pharma".into(),
                "daiwa".into(),
                "kyocera".into(),
                "subaru".into(),
                "shimano".into(),
                "resona holding".into(),
                "pan pacific international holding".into(),
                "sekisui".into(),
                "nexon".into(),
                "eneos".into(),
                "kepco".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: None,
            misc: Some(vec![
                "free patriotic movement".into(),
                "amal movement".into(),
                "hezbollah".into(),
                "march 14 alliance".into(),
                "march 8 alliance".into(),
            ]),
        }
        .get_region_vec(),
        "Lebanon".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            misc: Some(vec![
                "christian social people's party".into(),
                "lsap".into(),
            ]),
        }
        .get_region_vec(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: None,
            misc: Some(vec![
                "national rally of independents".into(),
                "istiqlal party".into(),
                "authenticity and modernity party".into(),
                "usfp".into(),
            ]),
        }
        .get_region_vec(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "grupo carso".into(),
                "grupo bimbo".into(),
                "financiero inbursa".into(),
                "arca continental".into(),
                "grupo elektra".into(),
                "cemex".into(),
                "aeroportuario del sureste".into(),
            ]),
            misc: None,
        }
        .get_region_vec(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "heineken".into(),
                "ing".into(),
                "universal music group".into(),
                "umg".into(),
                "adyen".into(),
                "exor".into(),
                "wolters kluwer".into(),
                "asm international".into(),
                "ahold delhaize".into(),
                "philips".into(),
                "argenx".into(),
                "yandex".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "sm holding".into(),
                "bdo".into(),
                "international container terminal services".into(),
                "ayala".into(),
            ]),
    ...
    map.push((
        ...
        .get_region_vec(),
        "Saint Pierre and Miquelon".into(),
    ));
    map.push((
        RegionKeyphrases {
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "sabic".into(),
                "maaden".into(),
                "dr. sulaiman al habib".into(),
                "riyad".into(),
                "alinma".into(),
                "elm co".into(),
                "almarai".into(),
                "albilad".into(),
                "arab national bank".into(),
                "etihad etisalat".into(),
                "mobily".into(),
            ]),
            misc: None,
        }
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "hexgon inc".into(),
                "skandinaviska".into(),
                "enskilda banken".into(),
                "h&m".into(),
                "sandvik".into(),
                "epiroc".into(),
                "evolution gaming".into(),
                "swedbank".into(),
                "ericsson".into(),
                "alfa laval".into(),
                "svenska".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            names: Some(vec![
                "french southern territories".into(),
                "adelie land".into(),
                "crozet island".into(),
                "kerguelen island".into(),
                "saint paul and amsterdam island".into(),
                "scattered islands".into(),
            ]),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                "ptt".into(),
                "advanced info service inc".into(),
                "cp all".into(),
                "gulf energy development public co".into(),
                "bdms".into(),
                "siam commercial".into(),
                "siam bank".into(),
            ]),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: None,
            misc: Some(vec![
                "assembly of the representatives of the people".into(),
                "25th of july movement".into(),
            ]),
        }
        .get_region_vec(),
        "Tunisia".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                ...
                "hon hai".into(),
                "mediatek".into(),
                "quanta computer".into(),
                "chunghwa telecom".into(),
                "fubon".into(),
                "delta electronics".into(),
                "cathay financial".into(),
                "cathay holding".into(),
                "ctbc".into(),
                "ase group".into(),
                "united microelectronics".into(),
                "mfhc".into(),
                "wiwynn".into(),
                "e.sun bank".into(),
                "uni-president enterprise".into(),
                "nan ya".into(),
                "evergreen marine".into(),
                "yuanta".into(),
                "asus".into(),
                "first financial holding inc".into(),
                "novatek microelectronics".into(),
                "hua nan".into(),
                "hotai motor".into(),
                "wistron corp".into(),
            ]),
            misc: Some(vec![
                "legislative yuan".into(),
                "kuomintang".into(),
                "guomindang".into(),
                "formosa".into(),
            ]),
    ...
    map.push((
        RegionKeyphrases {
            ...
            names: Some(vec![
                "united states minor outlying islands".into(),
                "baker island".into(),
                "howland island".into(),
                "jarvis island".into(),
                "johnston atoll".into(),
    ...
    map.push((
        RegionKeyphrases {
            ...
            names: Some(vec!["usa".into(), "u.s.a.".into()]),
            demonyms: None,
            enterprises: Some(vec![
                "microsoft".into(),
                "apple inc".into(),
                ...
                "mastercard".into(),
                "proctor & gamble".into(),
                "johnson & johnson".into(),
                "costco".into(),
                "home depot".into(),
                "oracle inc".into(),
                "merck".into(),
                "bank of america".into(),
                "chevron".into(),
                "abbvie".into(),
                "salesforce".into(),
                "coca-cola".into(),
                ...
                "applied materials inc".into(),
                "general electric".into(),
                "american express".into(),
                "caterpillar inc".into(),
                "verizon".into(),
                "amgen".into(),
                "morgan stanley".into(),
                "pfizer".into(),
                ...
                "comcast".into(),
                "goldman sachs".into(),
                "union pacific corp".into(),
                "charles schwab".into(),
                "conocophillips".into(),
                "intuitive surgical".into(),
                "nike".into(),
                "micron technology".into(),
                "raytheon".into(),
                "s&p global".into(),
                "uber inc".into(),
                "intel inc".into(),
                ...
                "ups".into(),
                "stryker corp".into(),
                "elevance health".into(),
                "booking holding".into(),
                "booking.com".into(),
                "at&t".into(),
                "progressive inc".into(),
                "citigroup".into(),
                "blackrock".into(),
                "lam research".into(),
                "vertex pharma".into(),
                "tjx co".into(),
                "boeing".into(),
                "lockheed martin".into(),
                "deere".into(),
                "boston scientific".into(),
                "regeneron pharma".into(),
                "dell".into(),
                "analog devices inc".into(),
                "marsh & mclennan".into(),
                "automatic data processing inc".into(),
                "prologis".into(),
                "palo alto".into(),
                "kla".into(),
                "arista networks".into(),
                "southern copper inc".into(),
                "kkr".into(),
                "cigna".into(),
                "mondelez".into(),
                "airbnb".into(),
                "fiserv".into(),
                "american tower inc".into(),
                "blackstone".into(),
                "bristol-meyers".into(),
                "chipotle".into(),
                "starbucks".into(),
                "southern company inc".into(),
                "synopsys".into(),
                "hca health".into(),
                "waste management inc".into(),
                "gilead science".into(),
                "crowdstrike".into(),
                "general dynamics".into(),
                "duke energy".into(),
                "zoetis".into(),
                "intercontinental exchange inc".into(),
                "amphenol".into(),
                "sherwin-williams".into(),
                "altria group".into(),
                "cadence design".into(),
                "freeport-mcmoran".into(),
                "colgate-palmolive".into(),
                "cme group".into(),
                "equinix".into(),
                "moody's".into(),
                "illinois tool works".into(),
                "eog resources".into(),
                "target inc".into(),
                "mckesson".into(),
                "cvs".into(),
                ...
                "fedex".into(),
                "marathon petro".into(),
                "pioneer natural resources".into(),
                "phillips 66".into(),
                "marvell tech".into(),
                "enterprise products inc".into(),
                "motorola".into(),
                "welltower".into(),
                "o'reilly auto".into(),
                "republic services inc".into(),
                "carrier inc".into(),
                "air products and chemicals inc".into(),
                "3m".into(),
                "roper tech".into(),
                "monster beverage".into(),
                "arthur j. gallagher".into(),
                "occidental petro".into(),
                "simon property".into(),
                "paccar".into(),
                "valero".into(),
                "capital one".into(),
                "snowflake inc".into(),
                "energy transfer partners inc".into(),
                "edwards lifesciences".into(),
                "truist financial".into(),
                "american international group".into(),
                "metlife".into(),
                "copart".into(),
                "norfolk southern".into(),
                "dexcom".into(),
                "general motors".into(),
                "supermicro".into(),
                "interactive brokers inc".into(),
                "hilton world".into(),
                "coinbase".into(),
                "microchip technology inc".into(),
                "moderna".into(),
                "public storage inc".into(),
                "autozone".into(),
                "newmont".into(),
                "the travelers companies".into(),
                "williams companies".into(),
                "aflac".into(),
                "d. r. horton".into(),
                "sempra".into(),
                "american electric power".into(),
                "ford".into(),
                "hess".into(),
                "pacific gas and electric".into(),
                "palantir".into(),
                "estee lauder".into(),
                "oneok".into(),
                "doordash".into(),
                "realty income inc".into(),
                "autodesk".into(),
                "fortinet".into(),
                "constellation brands".into(),
                "w. w. grainger".into(),
                "the trade desk inc".into(),
                "united rentals".into(),
                "keurig".into(),
                "dr pepper".into(),
                "lennar inc".into(),
                ...
                "kimberly-clark".into(),
                "agilent tech".into(),
                "ares management".into(),
                "idexx lab".into(),
                "dominion energy".into(),
                "allstate".into(),
                "crown castle".into(),
                "block inc".into(),
                "bank of new york mellon".into(),
                "ross stores".into(),
                "cencora".into(),
                "kinder morgan".into(),
                "kraft".into(),
                "heinz".into(),
                "fidelity national".into(),
                "prudential financial".into(),
                "waste connections inc".into(),
                "ameriprise financial".into(),
                "humana".into(),
                "l3harris".into(),
                "iqvia".into(),
                "hershey".into(),
                ...
                "pseg".into(),
                "cheniere".into(),
                "royal caribbean".into(),
                "vertiv".into(),
                "nasdaq".into(),
                "verisk".into(),
                "martin marietta".into(),
                "costar group".into(),
                "monolithic power systems inc".into(),
                "diamondback energy".into(),
                "las vegas sands".into(),
                "gartner inc".into(),
                "fico".into(),
                "xylem".into(),
                "vulcan materials".into(),
                "cognizant technology solutions".into(),
                "electronic arts".into(),
                "delta air".into(),
                "veeva".into(),
                "howmet aero".into(),
                "bakar hughes".into(),
                "consolidated edison".into(),
                "biogen inc".into(),
                "halliburton".into(),
                "extra space storage inc".into(),
                "dupont de nemours".into(),
                "lyondellbasell".into(),
                "vistra".into(),
                "mettler-toledo".into(),
                "resmed".into(),
                "vici properties".into(),
                "ppg industries".into(),
                "on semiconductor inc".into(),
                "discover financial".into(),
                "devon energy".into(),
                "hubspot".into(),
                "dollar general".into(),
                "xcel energy".into(),
                ...
                "corning".into(),
                "cdw corp".into(),
                "globalfoundries".into(),
                "wabtec".into(),
                "edison international".into(),
                "pinterest".into(),
                "ansys".into(),
                "avalonbay".into(),
                "microstrategy".into(),
                "rocket companies".into(),
                "cbre group".into(),
                "global payments inc".into(),
                "keysight".into(),
                "fortive".into(),
                "blue owl capital".into(),
                "applovin".into(),
                "mongodb".into(),
                "wec energy".into(),
                "zscaler".into(),
                "splunk".into(),
                "fifth third bank".into(),
                "snap inc".into(),
                "heico".into(),
                "raymond james".into(),
                "targa resources".into(),
                "t. rowe price".into(),
                "ebay".into(),
                "american water works inc".into(),
                "west pharma".into(),
                "church & dwight".into(),
                "symbiotic inc".into(),
                "m&t bank".into(),
                ...
                "dollar tree".into(),
                "cloudflare".into(),
                "first citizens banc".into(),
                "international flavors & fragrances".into(),
                "equity residential".into(),
                "dover".into(),
                "take 2 interactive".into(),
                "pultegroup".into(),
                "zimmer biomet".into(),
                "tradeweb".into(),
                "entergy".into(),
                "cardinal health".into(),
                "dte energy".into(),
                "broadridge financial".into(),
                "nvr".into(),
                "iron mountain".into(),
                "cheniere energy".into(),
                "western digital inc".into(),
                "state street corp".into(),
                "hewlett packard".into(),
                "brown forman".into(),
                "firstenergy".into(),
                "deckers brands".into(),
                "netapp".into(),
                "weyerhaeuser".into(),
                "samsara".into(),
                "live nation inc".into(),
                "rollins".into(),
                "ptc".into(),
                "ppl".into(),
                "axon enterprise".into(),
                "fleetcor".into(),
                "ball corp".into(),
                "alexandria real estate".into(),
                "invitation homes".into(),
                "celsius holding".into(),
                "markel".into(),
                "eversource".into(),
                "tyson foods".into(),
                "sba comm".into(),
                "genuine parts co".into(),
                "first solar inc".into(),
                "waters corp".into(),
                "hubbell".into(),
                "roblox".into(),
                "draftkings".into(),
                "kellogg".into(),
                "steel dynamics inc".into(),
                "coterra".into(),
                "carvana".into(),
                "tyler tech".into(),
                "erie indemnity".into(),
                "huntington banc".into(),
                "teradyne".into(),
                "freddie mac".into(),
                "align tech".into(),
                "builders firstsource".into(),
                "molina health".into(),
                "westlake chem".into(),
                "w. r. berkley".into(),
                "leidos".into(),
                ...
                "zoom".into(),
                "hormel foods".into(),
                "williams-sonoma".into(),
                "mccormick".into(),
                "carlisle companies".into(),
                "ventas".into(),
                "booz allen".into(),
                "carnival corporation inc".into(),
                "entegris".into(),
                "warner bros".into(),
                "cooper companies".into(),
                "cboe".into(),
                "ulta".into(),
                "teledyne".into(),
                "centerpoint".into(),
                "pure storage inc".into(),
                "godaddy".into(),
                "watsco".into(),
                "corebridge".into(),
                "alnylam pharma".into(),
                "cms energy".into(),
                "omnicom".into(),
                "cincinnati financial".into(),
                "regions financial".into(),
                "darden restaurants".into(),
                "avery dennison".into(),
                "eqt corp".into(),
                "united airlines".into(),
                "baxter".into(),
                "atmos energy".into(),
                "domino's".into(),
                "emcor".into(),
                ...
                "reliance steel".into(),
                "factset".into(),
                "jacobs engineering".into(),
                "j. b. hunt".into(),
                "verisign".into(),
                "textron".into(),
                "avantor".into(),
                "bentley systems".into(),
                "citizens financial group".into(),
                "clorox".into(),
                "idex".into(),
                "formula one".into(),
                ...
                "expeditors inc".into(),
                "warner music".into(),
                "mid-america apartment communities inc".into(),
                "packaging corporation of america".into(),
                "zebra tech".into(),
                "quest diagnostics".into(),
                "dick's sporting".into(),
                "sun communities".into(),
                "best buy inc".into(),
                "ss&c tech".into(),
                "walgreens".into(),
                "gen digital".into(),
                ...
                "fox corp".into(),
                "marathon oil".into(),
                "biomarin pharma".into(),
                "snap-on inc".into(),
                "conagra".into(),
                "rpm international".into(),
                "bunge inc".into(),
                "keycorp".into(),
                "keybank".into(),
                "akamai".into(),
                "western midstream".into(),
                "neurocrine bio".into(),
                "dynatrace".into(),
                "international paper inc".into(),
                "ryan specialty".into(),
                "manhattan associates".into(),
                "poolcorp".into(),
                "aspentech".into(),
                "graco".into(),
                "texas pacific land trust".into(),
                "physicians realty".into(),
                "reinsurance group of america".into(),
                "trimble".into(),
                "cf industries".into(),
                "jabil".into(),
                "black & decker".into(),
                ...
                "revvity".into(),
                "us foods inc".into(),
                "advanced drainage systems inc".into(),
                "alliant energy".into(),
                "permian resources".into(),
                "ovintiv".into(),
                "equitable holding inc".into(),
                "bio-techne".into(),
                "host hotels & resorts".into(),
                "w. p. carey".into(),
                "insulet".into(),
                "nisource".into(),
                "viatris".into(),
                ...
                "kimco realty".into(),
                "ares hospital".into(),
                "lincoln electric".into(),
                "mgm resorts".into(),
                "topbuild".into(),
                "incyte".into(),
                "xpo logistics".into(),
                "morningstar".into(),
                "franklin resources".into(),
                "floor & decor inc".into(),
                "evergy".into(),
                "equity lifestyle".into(),
                "karuna".into(),
                "a. o. smith".into(),
                "tenet health".into(),
                "lamb western".into(),
                "gaming and leisure properties".into(),
                "sarepta".into(),
                "casey's general".into(),
                "shockwave".into(),
                "burlington".into(),
                "docusign".into(),
                "jack henry".into(),
                "cna financial".into(),
                "davita".into(),
                "lamar advertising".into(),
                "smucker".into(),
                "aecom".into(),
                "ally inc".into(),
                "medspace".into(),
                "plains all american pipeline".into(),
                "united therapeutics".into(),
                "core & main".into(),
                "interpublic".into(),
                "chesapeake energy".into(),
                "molson coors".into(),
                "lkq corp".into(),
                "albertsons".into(),
                "universal health services inc".into(),
                "eastman chem".into(),
                "tetra tech".into(),
                "uipath".into(),
                "sirius xm".into(),
                "performance food".into(),
                "clean harbors inc".into(),
                "itt".into(),
                "apache corp".into(),
                "carmax".into(),
                "uwm holding".into(),
                "charles river lab".into(),
                "camden property".into(),
                "wingstop".into(),
                "texas roadhouse".into(),
                "regency centers".into(),
                "comfort systems inc".into(),
                "astera lab".into(),
                "juniper networks".into(),
                "sinclair".into(),
                "bath & body works".into(),
                "pershing square".into(),
                "american financial group inc".into(),
                "boston properties inc".into(),
                "elastic nv".into(),
                "onto innovation".into(),
                "woodward".into(),
                "bruker".into(),
                "zoominfo".into(),
                "epam systems".into(),
                "antero resources".into(),
                "essential utilities inc".into(),
                "wynn resorts".into(),
                "td synnex".into(),
                "east west bancorp".into(),
                "ralph lauren".into(),
                "curtiss-wright".into(),
                "twilio".into(),
                "regal rexnord".into(),
                ...
                "sharkninja".into(),
                "zillow".into(),
                "rexford industrial".into(),
                "service corporation international".into(),
                "crown holding".into(),
                "teleflex".into(),
                "confluent inc".into(),
                "guidewire".into(),
                ...
                "procore".into(),
                "reddit".into(),
                "huntington ingalls".into(),
                "unum".into(),
                "cubesmart".into(),
                "lattice semiconductor".into(),
                "jefferies financial".into(),
                "catalent".into(),
            ]),
            misc: None,
        }
    ...
    map.push((
        ...
        .get_region_vec(),
        "Saint Vincent and the Grenadines".into(),
    ));
    map.push((
        RegionKeyphrases {
    ...
    map.push((
        ...
        .get_region_vec(),
        "British Virgin Islands".into(),
    ));
    map.push((
        RegionKeyphrases {
            automated: get_automated_keyphrases(&region_map, "VI"),
            names: Some(vec![
                "united states virgin islands".into(),
                "us virgin islands".into(),
                "u.s. virgin islands".into(),
            ]),
            demonyms: None,
            enterprises: None,
            misc: None,
    ...
    map.push((
        RegionKeyphrases {
            ...
            enterprises: Some(vec![
                "naspers".into(),
                "firstrand".into(),
                "standard bank group inc".into(),
                "gold fields inc".into(),
                "capitec".into(),
                "anglogold".into(),
                "vodacom".into(),
            ]),
    ...
    map.push((
        RegionKeyphrases {
            ...
            misc: Some(vec![
                "zanu-pf".into(),
                "citizens coalition for change".into(),
            ]),
        }
        .get_region_vec(),
        "Zimbabwe".into(),
    ...
    let blacklist = vec![
        ...
        "south coast".into(),
        "west coast".into(),
        "northern province".into(),
        "eastern province".into(),
        "southern province".into(),
        "western province".into(),
        "central province".into(),
        "north province".into(),
        "east province".into(),
        "south province".into(),
        "west province".into(),
        "centre province".into(),
        "northern region".into(),
        "eastern region".into(),
        ...
        "eastern territory".into(),
        "southern territory".into(),
        "western territory".into(),
        "central territory".into(),
        "north territory".into(),
        "east territory".into(),
        "south territory".into(),
        "west territory".into(),
        "centre territory".into(),
        "northern island".into(),
        "eastern island".into(),
        "southern island".into(),
        "western island".into(),
        "central island".into(),
        "north island".into(),
        "east island".into(),
